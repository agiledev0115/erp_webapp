...
// define lets x and y for t_current_stock class and t_cs_editable class
    ...
    let y = document.getElementsByClassName("t_cs_editable");
    let i;
    // loop over the length of t_current_stock class, for each element in t_current_stock class hide the element
    // for each element in t_cs_editable class, make them visible to enter value
